...
extension UIDeviceOrientation {
    func getUIImageOrientationFromDevice() -> UIImageOrientation {
        ...
        switch self {
        case UIDeviceOrientation.portrait, .faceUp: return UIImageOrientation.up
        case UIDeviceOrientation.portraitUpsideDown, .faceDown: return UIImageOrientation.down
        case UIDeviceOrientation.landscapeLeft: return UIImageOrientation.left
        case UIDeviceOrientation.landscapeRight: return UIImageOrientation.right
